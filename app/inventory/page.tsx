...
import { ArrowRightLeft, ArrowUpDown, Bookmark, Eye } from "lucide-react";
                  ...
                  <StatusBadge value={r.status} />
                   ...
                   <TableCell className={tableCellActions}>
                    <div className="grid grid-cols-2 place-items-center gap-1">
                      <IconActionButton icon={<Eye className="h-4 w-4" />} label="View" onClick={() => setViewId(r.variantId)} />
                      <IconActionButton icon={<ArrowUpDown className="h-4 w-4" />} label="Adjust" onClick={() => setAction({ type: "adjust", row: r })} />
                      <IconActionButton icon={<ArrowRightLeft className="h-4 w-4" />} label="Transfer" onClick={() => setAction({ type: "transfer", row: r })} />
                      <IconActionButton icon={<Bookmark className="h-4 w-4" />} label="Reserve" onClick={() => setAction({ type: "reserve", row: r })} />
                    </div>
                  </TableCell>
              </TableRow>
            ))}
