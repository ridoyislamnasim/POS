...
const PENDING = /^(PENDING|DRAFT|HOLD|QUEUED|ASSIGNED|PARTIAL|PARTIALLY_RETURNED|CONFIRMED|PACKED|SHIPPED|OPEN)$/i;
const WARNING = /^(WARNING|LOW|LATE|HALF_DAY|IN_TRANSIT|PARTIAL)$/i;
const DANGER = /^(REJECTED|CANCELLED|CANCELED|VOIDED|FAILED|DEACTIVATED|INACTIVE|OUT_OF_STOCK|ABSENT|DAMAGE|DAMAGED|LOSS|SHRINKAGE|FULLY_RETURNED)$/i;
